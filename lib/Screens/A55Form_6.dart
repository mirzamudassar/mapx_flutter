...
class A55_6Page extends StatefulWidget {
  const A55_6Page ({super.key});

  @override
  State<A55_6Page> createState() => _A55_6PageState();
}

class _A55_6PageState extends State<A55_6Page> with SingleTickerProviderStateMixin {
...
class A55_6PageWidgets extends StatefulWidget {
   const A55_6PageWidgets ({Key? key}) : super(key: key);
  @override
